...
const i18n = {
  ar: {
    ...
    millRegSub: 'سجّل اسمك للبدء',
    millBestPrize: 'أفضل ربح',
    millGamesPlayed: 'ألعاب لُعبت',
    millWins: 'انتصارات',
    millTotalPrize: 'المجموع',
    millHistory: '📜 السجل',
    millCertTitle: 'شهادة ربح',
    millCertSub: 'نشهد أن',
    millCertAchieved: 'حقّق في لعبة "من سيربح المليون — رمضان"',
  ...
  fr: {
    ...
    millRegSub: 'Inscrivez votre nom pour commencer',
    millBestPrize: 'Meilleur gain',
    millGamesPlayed: 'Parties jouées',
    millWins: 'Victoires',
    millTotalPrize: 'Total',
    millHistory: '📜 Historique',
    millCertTitle: 'Certificat de gains',
    millCertSub: 'Nous attestons que',
    millCertAchieved: 'a réalisé dans le jeu « Qui veut gagner des millions — Ramadan »',
